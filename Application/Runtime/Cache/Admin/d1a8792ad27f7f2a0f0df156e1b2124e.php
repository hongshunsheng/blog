                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="link_title" name="link_title" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>链接地址：</th>
                                <td>
                                    <input class="common-text required" id="link_url" name="link_url" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>链接描述：</th>
                                <td>
                                    <textarea style="width:420px;height: 100px;" name="link_desc"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
