    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                ...
                <li><a href="/blog/index.php/Admin/Link/edit/id/<?php echo $_SESSION['id']?>">修改密码</a></li>
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="common-text required" id="link_title" name="link_title" size="50" value="<?php echo ($link["title"]); ?>" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>链接地址：</th>
                            <td>
                                <input class="common-text required" id="link_url" name="link_url" size="50" value="<?php echo ($link["url"]); ?>" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>链接描述：</th>
                            <td>
                                <textarea style="width:420px;height: 100px;" name="link_desc"><?php echo ($link["desc"]); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th></th>
